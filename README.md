...
MSc Data Science graduate exploring roles in **Data Science, Data Analysis and Data Engineering**. I'm drawn to the process of digging into messy, multi-variable datasets to find the patterns underneath — and building models that make sense of them.<br><br>


📍 Caterham, UK · [LinkedIn](https://linkedin.com/in/aditi-kalyanaraman-609aa42b8) · aditikalyan.p@gmail.com<br>

Currently: Technology Intern @ Brytehub — working with Docker, Git, FastAPI and Agile workflows in an enterprise setting.<br><br>


🔬 Featured Projects<br>
1. Ecosystem Modelling of the Baltic Sea — Dynamic Bayesian Networks<br>
**MSc Dissertation | University of Aberdeen | 2025**<br>
...
**Stack**: R, Dynamic Bayesian Networks, time-series forecasting, data visualisation 📄 [Link to dissertation write-up / PDF]https://github.com/AditiK-9/Baltic-sea-dbn-forecasting/blob/f789b66ffdb172e226aa2cd6003e8b22af566de0/MSc_Dissertation__final_.pdf · 📊 [Link to visualisations, if shareable] · 💻 [Link to R code repo]https://github.com/AditiK-9/Baltic-sea-dbn-forecasting/tree/5d555a99c340e9453bfae4228ec336fdddee2baa/R%20code<br><br>
...
A small backend project applying what I'm learning in my current internship — FastAPI, Docker, and Git workflows — to build something independently and publicly shareable.<br>

**Problem**: [what does this app manage — e.g. user registration, roles, authentication?]<br>
**What I did**: Built a user management API with FastAPI, containerised with Docker, version-controlled with Git using proper commit/branch discipline.<br>
**Why it matters**: Demonstrates I can independently apply enterprise tooling and patterns (not just follow along in a structured session).<br>
